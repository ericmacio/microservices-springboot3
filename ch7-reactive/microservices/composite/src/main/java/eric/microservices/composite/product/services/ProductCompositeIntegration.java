...
import static eric.api.event.Event.Type.CREATE;
import static eric.api.event.Event.Type.DELETE;
...
public class ProductCompositeIntegration implements ProductApi, RecommendationApi, ReviewApi {
  ...
  public ProductCompositeIntegration(
    ...
    productApiUrl = "http://" + productServiceHost + ":" + productServicePort;
    recommendationApiUrl = "http://" + recommendationServiceHost + ":" + recommendationServicePort;
    reviewApiUrl = "http://" + reviewServiceHost + ":" + reviewServicePort;
  }

  @Override
  public Mono<Product> postProduct(Product body) {
    return Mono.fromCallable(() -> {
      LOG.info("postProduct - Mono.fromCallable");
  ...
  public Mono<Recommendation> createRecommendation(Recommendation body) {
    return Mono.fromCallable(() -> {
      LOG.info("createRecommendation - Mono.fromCallable");
  ...
  public Flux<Recommendation> getRecommendations(int productId) {
    String url = recommendationApiUrl + "/recommendation?productId=" + productId;
  ...
  public Mono<Review> createReview(Review body) {
    return Mono.fromCallable(() -> {
      LOG.info("createReview - Mono.fromCallable");
  ...
  public Flux<Review> getReviews(int productId) {
    String url = reviewApiUrl + "/review?productId=" + productId;
  ...
  public Mono<Health> getProductHealth() {
    return getHealth(productApiUrl);
  }

  public Mono<Health> getRecommendationHealth() {
    return getHealth(recommendationApiUrl);
  }

  public Mono<Health> getReviewHealth() {
    return getHealth(reviewApiUrl);
  }
