...
import eric.api.core.recommendation.RecommendationService;
import eric.api.core.review.Review;
import eric.api.core.review.ReviewService;
    ...
    try {
      ...
      return product;
        ...
        switch (HttpStatus.resolve(ex.getStatusCode().value())) {
          case NOT_FOUND:
            LOG.error("Receive HTTP NOT_FOUND status. Throw NotFoundException Exception");
            throw new NotFoundException(getErrorMessage(ex));
          case UNPROCESSABLE_ENTITY:
            LOG.error("Receive HTTP UNPROCESSABLE_ENTITY status. Throw InvalidInputException Exception");
